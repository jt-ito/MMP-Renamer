...
export default function normalizeEnrichResponse(data) {
  ...
  const provider = (e.provider) ? e.provider : ((e.episodeTitle || e.year || e.providerRenderedName || e.tmdb) ? { 
    title: e.title || parsed && parsed.title || '', 
    year: e.year || null, 
    season: e.season, 
    episode: e.episode, 
    episodeTitle: e.episodeTitle || '', 
    raw: e.provider || e.tmdb || null, 
    renderedName: e.providerRenderedName || e.renderedName || null, 
    matched: !!(e.title || e.episodeTitle),
    source: e.source || (e.provider && e.provider.source) || null
  } : null)
