...
class AniDBUDPClient {
  ...
  _parseAnimeResponse(data) {
    ...
    // The exact order depends on which amask bits are set
    // Try common patterns: aid|year|type|romaji|kanji|english|shorts|synonyms
    const result = {
      raw: data,
      aid: fields[0] || null,
      year: fields[1] || null,
      type: fields[2] || null,
      // Try both common field orders
      romajiName: fields[3] || null,
      kanjiName: fields[4] || null,
      englishName: fields[5] || null,
      shortNames: fields[6] || null,
      synonyms: fields[7] || null,
