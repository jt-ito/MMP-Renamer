    ...
    try {
      ...
      try {
        ...
        try {
          ...
          console.log('[MetaProviders] AniDB HTTP result:', JSON.stringify(fileInfo).slice(0, 500));
        } catch (httpError) {
      ...
      if (fileInfo) {
        ...
        console.log('[MetaProviders] AniDB animeTitle:', fileInfo.animeTitle);
        console.log('[MetaProviders] AniDB episodeName:', fileInfo.episodeName);
        console.log('[MetaProviders] AniDB episodeRomaji:', fileInfo.episodeRomaji);
