    ...
    try {
      ...
      if (episodeInfo && episodeInfo.aid) {
        ...
        if (animeResponse) {
          ...
          const englishTitle = pickTitle(animeResponse.englishName || animeResponse.animeEnglishName);
          const romajiTitle = pickTitle(animeResponse.romajiName || animeResponse.animeRomajiName);
          ...
          if (englishEpTitle && !isPlaceholderEpisodeTitle(englishEpTitle)) {
            episodeTitle = englishEpTitle;
          } else if (romajiEpTitle && !isPlaceholderEpisodeTitle(romajiEpTitle)) {
