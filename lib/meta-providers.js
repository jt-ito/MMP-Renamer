...
async function lookupMetadataWithAniDB(filePath, title, opts = {}, forceHash = false) {
  ...
  // AniDB doesn't have seasons like western TV. Only set seasonNumber if explicitly provided in opts.
  result.seasonNumber = (opts && typeof opts.season !== 'undefined' && opts.season !== null) ? opts.season : null;
        result.raw = fileInfo;
