...
async function waitForRateLimit(requestType = 'generic') {
  // UDP requests (AUTH, LOGOUT, FILE, etc.) use a separate queue so they don't
  // block behind HTTP requests or the HTTP bulk-operation pause.
  ...
  try {
    ...
    // All UDP variants (requestType starting with 'UDP') bypass this pause.
